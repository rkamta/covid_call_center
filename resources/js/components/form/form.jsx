        ...
        <div className='react-form-builder-form'>
          <form encType='multipart/form-data' ref={c => this.form = c} action={this.props.form_action} onSubmit={this.handleSubmit.bind(this)} method={this.props.form_method}>
            <div className="elements-group">
              ...
              { this.getDataItems(this.props.data).length ? 
                items 
                :
                <div className="text-center text-muted" style={emptyStyle}>Empty</div>
              }
              <input type="hidden" name="items" value={ this.getDataItemsString(this.props.data) }/>
              <input type="hidden" name="user_id" value={ this.props.user_id }/>
            </div>
            <div className='form-btns text-center'>
              { !this.props.hide_actions ?
                <input type='submit' className='btn btn-primary btn-md btn-block' value={actionName} />
                : <p className="m-0 text-center text-muted">Select a supervisor to get this form, please!</p>
              }
            </div>
          </form>
        </div>
