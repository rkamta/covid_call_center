...
export default class Demobar extends React.Component {
  ...
  render() {
    let modalClass = 'modal modal-preview';
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h4 className="text-center">Form Preview</h4>
                  <button type="button" className="close" data-dismiss="modal" onClick={this.closePreview.bind(this)}>&times;</button>
                </div>
