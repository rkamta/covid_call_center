                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " id="password-confirm" type="password" class="form-control" name="password_confirmation" 
                                        placeholder="password again" required autocomplete="new-password">
                                    </div>
                                </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-6 offset-md-4 mt-3">
                                <a href="{{ url('auth/google') }}" class="btn btn-warning btn-block">
                                    {{ __('Register with G+') }}
                                </a>
                            </div>
                        </div>
