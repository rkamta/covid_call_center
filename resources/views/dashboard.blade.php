...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Hi, <strong class="text-muted">{{ Auth::user()->name }}</strong> !</h3>
            ...
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        ...
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">All Users</h6>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        ...
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Patients
                        </h6>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0">
                        <span class="opacity-7 text-muted"><i data-feather="alert-octagon"></i></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        ...
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Data</h6>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0">
                        <span class="opacity-7 text-muted"><i data-feather="arrow-down-circle"></i></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3 align-items-center">
                        <div class="col-4 text-right">
                            <span class="text-muted font-14">Spain</span>
                        </div>
                        <div class="col-5">
                            <div class="progress" style="height: 5px;">
                    ...
                    <div class="row mb-3 align-items-center">
                        <div class="col-4 text-right">
                            <span class="text-muted font-14">Italy</span>
                        </div>
                        <div class="col-5">
                            <div class="progress" style="height: 5px;">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-4 text-right">
                            <span class="text-muted font-14">Iran</span>
                        </div>
                        <div class="col-5">
                            <div class="progress" style="height: 5px;">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        <h4 class="card-title mb-0">Patients Statistics</h4>
                        <div class="ml-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <h4 class="card-title">Top Managers</h4>
                        <div class="ml-auto">
                            <div class="dropdown sub-dropdown">
                                <button class="btn btn-link text-muted dropdown-toggle" type="button" id="dd1"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <table class="table no-wrap v-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="border-top-0 px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img
                                                    src="{{ asset('images/users/widget-table-pic1.jpg') }}" alt="user"
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img src="{{ asset('images/users/widget-table-pic2.jpg') }}"
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img src="{{ asset('images/users/widget-table-pic3.jpg') }}"
                                                    alt="user" class="rounded-circle" width="45" height="45" /></div>
                                            <div class="">
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img src="{{ asset('images/users/widget-table-pic4.jpg') }}"
                                                    alt="user" class="rounded-circle" width="45" height="45" /></div>
                                            <div class="">
...
<script src="{{ asset('lib/c3/d3.min.js') }}"></script>
<script src="{{ asset('lib/c3/c3.min.js') }}"></script>
<script src="{{ asset('lib/chartist/dist/chartist.min.js') }}"></script>
<script src="{{ asset('lib/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js') }}"></script>
<script src="{{ asset('lib/jvector/jquery-jvectormap-2.0.2.min.js') }}"></script>
<script src="{{ asset('lib/jvector/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('js/pages/pages/dashboards/dashboard1.js') }}"></script>
@endsection